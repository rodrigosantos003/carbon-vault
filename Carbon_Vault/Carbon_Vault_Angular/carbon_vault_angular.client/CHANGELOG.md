...
- Create Angular project with ng: `ng new carbon_vault_angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`carbon_vault_angular.client.esproj`).
