...
export async function testCreditsSellCriterion(driver, projectId) {
    ...
    // Verifica se foi acionado um alert
    ...
    // 1️⃣2️⃣ Testa se deixa números negativos no preço
    await priceInput.clear();
    ...
    // 1️⃣3️⃣ Testa se deixa vender mais créditos do que os que tem disponíveis
    await quantityInput.clear();
