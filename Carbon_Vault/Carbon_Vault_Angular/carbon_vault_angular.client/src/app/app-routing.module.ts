...
const routes: Routes = [
  ...
  { path: 'project-manager/:id', component: ProjectManagerDetailsAdminComponent, canActivate: [AuthGuard , ValidParamGuard , PermissionGuard], data: { requiredRole: 1 } },
  ...
  { path: 'request-report', component: RequestReportComponent , canActivate: [AuthGuard, PermissionGuard],data: { requiredRole: 0 } },
  { path: 'admin-reports', component: AdminReportsComponent , canActivate: [AuthGuard, PermissionGuard],data: { requiredRole: 2 } },
